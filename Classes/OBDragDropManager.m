...
#define OBDRAGDROPMANAGER_IS_IOS8_OR_LATER ([[[UIDevice currentDevice] systemVersion] compare:@"8.0" options:NSNumericSearch] != NSOrderedAscending)
...
-(id) init
{
    ...
    if (self)
    {
        if (OBDRAGDROPMANAGER_IS_IOS8_OR_LATER)
        {
...
-(void) handleOvumGesture:(UIGestureRecognizer <OBDragDropGestureRecognizer>*)recognizer
{
    ...
    CGPoint locationInOverlayWindow = OBDRAGDROPMANAGER_IS_IOS8_OR_LATER ? [recognizer locationInView:overlayWindow] : locationInHostWindow;
